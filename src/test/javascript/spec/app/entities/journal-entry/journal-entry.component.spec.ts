...
import { JournalEntryComponent } from 'app/entities/journal-entry/journal-entry.component';
...
describe('Component Tests', () => {
  describe('JournalEntry Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.journalEntries[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
